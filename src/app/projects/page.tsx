...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "A curated index of Gunnþór Karl Rafnsson's projects: Sagas of Blood & Fire, Landlíf, Nafnaval, SpinPage and MemeGuessr. What each one is, why it exists, and what it is built with.",
